...
#Non mi vado a collegare con il server ma con il processo mongod dell'applicazione
#una volta collegato posso mandare comandi che il processo mongod deve mandare al server
#Quello che devo fare è fare in modo che l'applicazione si vada a collegare al mio mockup e non al database originale
#L'applicazione sarà in locale
