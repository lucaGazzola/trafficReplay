...
req_data = {'documents': [{'_class': 'org.jhipster.store.domain.Product', '_id': {'$oid': '5b7321750274390001fce771'}, 'name': 'prod1', 'price': '12.33'}], 'insert': 'product', 'ordered': True}
print('assert: number of request data')
assert len(req_data)  == 3

doc = [{'_class': 'org.jhipster.store.domain.Product', '_id': {'$oid': '5b7321750274390001fce771'}, 'name': 'prod1', 'price': '12.33'}]
doc_test = [{'_class': 'org.jhipster.store.domain.Product', '_id': {'$oid': '5b7321750274390001fce771'}, 'name': 'prod1', 'price': '12.33'}]
