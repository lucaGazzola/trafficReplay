...
print('sending put request to http://localhost:7000/stistics/Test1')
response = requests.put('http://localhost:7000/stistics/Test1', data = json.dumps(data), headers=headers)
