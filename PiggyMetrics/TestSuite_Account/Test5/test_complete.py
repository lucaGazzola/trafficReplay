...
headers={'Content-type': 'application/json', 'Accept': 'application/json', 'Authorization': 'Bearer 30f095f4-611d-48d4-8dee-5b0cf142ac4a'}
...
packet_data = '{"error":"invalid_token","error_description":"30f095f4-611d-48d4-8dee-5b0cf142ac4a"}'
