...
packet_data = '{"timestamp":"2019-01-30T17:55:57.453+0000","status":400,"error":"Bad Request","errors":[{"codes":["NotNull.account.incomes[0].amount","NotNull.account.incomes.amount","NotNull.incomes[0].amount","NotNull.incomes.amount","NotNull.amount","NotNull.java.math.BigDecimal","NotNull"],"arguments":[{"codes":["account.incomes[0].amount","incomes[0].amount"],"arguments":null,"defaultMessage":"incomes[0].amount","code":"incomes[0].amount"}],"defaultMessage":"must not be null","objectName":"account","field":"incomes[0].amount","rejectedValue":null,"bindingFailure":false,"code":"NotNull"}],"message":"Validation failed for object=\'account\'. Error count: 1","path":"/accounts/current"}'
