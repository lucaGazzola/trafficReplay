...
packet_data = '{"timestamp":"2019-01-30T17:56:43.642+0000","status":400,"error":"Bad Request","errors":[{"codes":["NotNull.account.incomes[0].icon","NotNull.account.incomes.icon","NotNull.incomes[0].icon","NotNull.incomes.icon","NotNull.icon","NotNull.java.lang.String","NotNull"],"arguments":[{"codes":["account.incomes[0].icon","incomes[0].icon"],"arguments":null,"defaultMessage":"incomes[0].icon","code":"incomes[0].icon"}],"defaultMessage":"must not be null","objectName":"account","field":"incomes[0].icon","rejectedValue":null,"bindingFailure":false,"code":"NotNull"}],"message":"Validation failed for object=\'account\'. Error count: 1","path":"/accounts/current"}'
