...
packet_data = '{"timestamp":"2019-01-30T17:54:42.017+0000","status":400,"error":"Bad Request","errors":[{"codes":["NotNull.account.expenses[0].icon","NotNull.account.expenses.icon","NotNull.expenses[0].icon","NotNull.expenses.icon","NotNull.icon","NotNull.java.lang.String","NotNull"],"arguments":[{"codes":["account.expenses[0].icon","expenses[0].icon"],"arguments":null,"defaultMessage":"expenses[0].icon","code":"expenses[0].icon"}],"defaultMessage":"must not be null","objectName":"account","field":"expenses[0].icon","rejectedValue":null,"bindingFailure":false,"code":"NotNull"}],"message":"Validation failed for object=\'account\'. Error count: 1","path":"/accounts/current"}'
