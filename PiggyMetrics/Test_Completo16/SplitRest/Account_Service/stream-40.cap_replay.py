...
packet_data = '{"timestamp":"2019-01-30T17:57:04.413+0000","status":400,"error":"Bad Request","errors":[{"codes":["NotNull.account.incomes[0].period","NotNull.account.incomes.period","NotNull.incomes[0].period","NotNull.incomes.period","NotNull.period","NotNull.com.piggymetrics.account.domain.TimePeriod","NotNull"],"arguments":[{"codes":["account.incomes[0].period","incomes[0].period"],"arguments":null,"defaultMessage":"incomes[0].period","code":"incomes[0].period"}],"defaultMessage":"must not be null","objectName":"account","field":"incomes[0].period","rejectedValue":null,"bindingFailure":false,"code":"NotNull"}],"message":"Validation failed for object=\'account\'. Error count: 1","path":"/accounts/current"}'
