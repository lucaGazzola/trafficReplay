...
packet_data = '{"timestamp":"2019-01-30T17:57:28.398+0000","status":400,"error":"Bad Request","errors":[{"codes":["NotNull.account.incomes[0].title","NotNull.account.incomes.title","NotNull.incomes[0].title","NotNull.incomes.title","NotNull.title","NotNull.java.lang.String","NotNull"],"arguments":[{"codes":["account.incomes[0].title","incomes[0].title"],"arguments":null,"defaultMessage":"incomes[0].title","code":"incomes[0].title"}],"defaultMessage":"must not be null","objectName":"account","field":"incomes[0].title","rejectedValue":null,"bindingFailure":false,"code":"NotNull"}],"message":"Validation failed for object=\'account\'. Error count: 1","path":"/accounts/current"}'
