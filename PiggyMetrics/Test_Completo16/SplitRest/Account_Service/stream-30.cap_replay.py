...
packet_data = '{"timestamp":"2019-01-30T17:55:02.932+0000","status":400,"error":"Bad Request","errors":[{"codes":["NotNull.account.expenses[0].period","NotNull.account.expenses.period","NotNull.expenses[0].period","NotNull.expenses.period","NotNull.period","NotNull.com.piggymetrics.account.domain.TimePeriod","NotNull"],"arguments":[{"codes":["account.expenses[0].period","expenses[0].period"],"arguments":null,"defaultMessage":"expenses[0].period","code":"expenses[0].period"}],"defaultMessage":"must not be null","objectName":"account","field":"expenses[0].period","rejectedValue":null,"bindingFailure":false,"code":"NotNull"}],"message":"Validation failed for object=\'account\'. Error count: 1","path":"/accounts/current"}'
