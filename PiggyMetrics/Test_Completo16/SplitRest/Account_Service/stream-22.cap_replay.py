...
packet_data = '{"timestamp":"2019-01-30T17:53:53.041+0000","status":400,"error":"Bad Request","errors":[{"codes":["NotNull.account.expenses[0].amount","NotNull.account.expenses.amount","NotNull.expenses[0].amount","NotNull.expenses.amount","NotNull.amount","NotNull.java.math.BigDecimal","NotNull"],"arguments":[{"codes":["account.expenses[0].amount","expenses[0].amount"],"arguments":null,"defaultMessage":"expenses[0].amount","code":"expenses[0].amount"}],"defaultMessage":"must not be null","objectName":"account","field":"expenses[0].amount","rejectedValue":null,"bindingFailure":false,"code":"NotNull"}],"message":"Validation failed for object=\'account\'. Error count: 1","path":"/accounts/current"}'
