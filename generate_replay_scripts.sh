...
# usage: ./generate_replay_scripts.sh captureStreamsDirectory port_gateway ports_list 
...
if [[ $# -lt 3 ]] ; then 
	echo 'missing args ---> ./generate_replay_scripts.sh <captureStreamsDirectory> <port_gateway> <ports_list>'
	exit 1
fi
