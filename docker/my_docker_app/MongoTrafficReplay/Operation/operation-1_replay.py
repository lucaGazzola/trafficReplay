...
rep_data = {'cursor': {'firstBatch': [{'_class': 'org.jhipster.store.domain.Product', '_id': {'$oid': '5b7321750274390001fce771'}, 'name': 'prod1', 'price': '12.33'}], 'id': {'$numberLong': '0'}, 'ns': 'store.product'}, 'ok': 1.0}
print('assert: number of reply data')
assert len(rep_data) == 2

cursor = {'firstBatch': [{'_class': 'org.jhipster.store.domain.Product', '_id': {'$oid': '5b7321750274390001fce771'}, 'name': 'prod1', 'price': '12.33'}], 'id': {'$numberLong': '0'}, 'ns': 'store.product'}
cursor_test = {'firstBatch': [{'_class': 'org.jhipster.store.domain.Product', '_id': {'$oid': '5b7321750274390001fce771'}, 'name': 'prod1', 'price': '12.33'}], 'id': {'$numberLong': '0'}, 'ns': 'store.product'}
