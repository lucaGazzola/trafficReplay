...
json_content = {"name":"prod7","price":12.33}
...
id_dict['5bd7595502743900018298a1'] = cont['id']
...
packet_data = '{"id":null,"name":"prod7","price":12.33}'
...
if 'path' in data_cont and data_cont['path'].endswith('/'):
	data_cont['path'] = data_cont['path'][:-1]
packet_data = '[{"id":null,"name":"prod1","price":12.33},{"id":null,"name":"prod5","price":23.33},{"id":null,"name":"prod7","price":12.33}]'
packet_data = re.sub(r'"timestamp".*?(?=,)', '"timestamp":null', packet_data)
data_pkt = loads(packet_data)
assert data_cont == data_pkt
...
data = json.loads('{"id":"5bd757f502743900018298a0","name":"prod5","price":25.33}')
...
if 'path' in data_cont and data_cont['path'].endswith('/'):
	data_cont['path'] = data_cont['path'][:-1]
packet_data = '{"id":null,"name":"prod5","price":25.33}'
packet_data = re.sub(r'"timestamp".*?(?=,)', '"timestamp":null', packet_data)
data_pkt = loads(packet_data)
assert data_cont == data_pkt
...
if 'path' in data_cont and data_cont['path'].endswith('/'):
	data_cont['path'] = data_cont['path'][:-1]
packet_data = '[{"id":null,"name":"prod1","price":12.33},{"id":null,"name":"prod5","price":25.33},{"id":null,"name":"prod7","price":12.33}]'
packet_data = re.sub(r'"timestamp".*?(?=,)', '"timestamp":null', packet_data)
data_pkt = loads(packet_data)
assert data_cont == data_pkt

url = 'http://localhost:8081/api/products/5bd757e4027439000182989f/'
if '5bd757e4027439000182989f' in id_dict:	url = url.replace("5bd757e4027439000182989f", id_dict['5bd757e4027439000182989f'])
print('sending get request to '+ url)
response = requests.get(url, headers=headers)
print('response: {0}'.format(response.content))
...
if 'path' in data_cont and data_cont['path'].endswith('/'):
	data_cont['path'] = data_cont['path'][:-1]
packet_data = '[{"id":null,"name":"prod5","price":25.33},{"id":null,"name":"prod7","price":12.33}]'
packet_data = re.sub(r'"timestamp".*?(?=,)', '"timestamp":null', packet_data)
data_pkt = loads(packet_data)
assert data_cont == data_pkt
