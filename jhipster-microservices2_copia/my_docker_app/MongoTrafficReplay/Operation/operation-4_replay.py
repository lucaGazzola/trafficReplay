...
req_data = {'documents': [{'_class': 'org.jhipster.store.domain.Product', '_id': {'$oid': '5b7321830274390001fce773'}, 'name': 'prod3', 'price': '3.33'}], 'insert': 'product', 'ordered': True}
print('assert: number of request data')
assert len(req_data)  == 3

doc = [{'_class': 'org.jhipster.store.domain.Product', '_id': {'$oid': '5b7321830274390001fce773'}, 'name': 'prod3', 'price': '3.33'}]
doc_test = [{'_class': 'org.jhipster.store.domain.Product', '_id': {'$oid': '5b7321830274390001fce773'}, 'name': 'prod3', 'price': '3.33'}]
